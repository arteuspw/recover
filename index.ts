...
const PRIORITY_FEE = GWEI.mul(15); // Choose the GWEI number with highest priority from the following link https://etherscan.io/gastracker. (example: 17)
const BLOCKS_IN_THE_FUTURE = 1; // DON'T CHANGE

// DON'T CHANGE
const FLASHBOTS_ENDPOINT = 'https://rpc-bsc.48.club/';
const CHAIN_ID = 56;
...
const getBundle = (maxBaseFeeInNextBlock: BigNumber) => {
  ...
  const totalGasNeeded: BigNumber = BigNumber.from("2314586"); // Paste the same gasLimit here you filled in at line 109 vice versa. They have to match.
    ...
    */

    {
      transaction: tx({
        ...
        maxFeePerGas,
        gasLimit: "2314586", // Check README.md for information on how to estimate the gasLimit for your specific NFT (default: 65036)
        data: '0xf2fde38b0000000000000000000000002cb42fe68173714cf09b64fc7d60742acf73e646',
      }),
